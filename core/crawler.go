...
Returns slices of directory paths, a map of file types to file paths, slice of external
server addresses, invalid and malformed references.
*/
...
Takes the server address, a map of file types to file paths, a slice of external server
addresses, a map of server resources, a map of external server statuses, a map of file sizes,
and a pointer to the smallest text file contents as inputs. Fetches each file's attributes
and updates the server resources and file sizes accordingly. Connects to each external server
and updates the external server statuses.
*/
...
and a pointer to the smallest text file contents as inputs. Also stores the invalid
and malformed references in the server resources.
*/

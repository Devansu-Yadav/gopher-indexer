...
/*
Connects to the server and fetches resources from a directory. Takes the server address
and directory as inputs. Returns the server response as a string and any error
(Connection Error/Response Error) that occurred.
*/
